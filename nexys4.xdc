...
#Note from Cole: if fpga_clk defined, it needs to be used in the design or else implementation fails dud to
#weird clock warning. Can get around with additional tcl property here but it isnt recommended.
set_property PACKAGE_PIN E3 [get_ports fpga_clk]							
